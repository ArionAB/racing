...
| **B→B'** | 0.14–0.20 | **Rampa de coborâre pe gheață** — pantă 15% de pe mal pe lac, marcaje cu bețe și stegulețe roșii ale drumului de gheață | intri pe gheață cu viteză; primul moment de „alunecă totul" | 7 → 10 m |
...
| **Placa care se înclină** | corp `AnimatableBody3D` care se rotește 3–4° când suma maselor de pe ea > prag; sunet + fisuri albe care apar; revine după 2 s | `IceSlabHazard` nou (logică ~ lift bridge + trigger de masă) |
