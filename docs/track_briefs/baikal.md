...
| 3 hazarde | câmpul de plăci crăpate la C (`IceFieldHazard` #312, a înlocuit cele 3 plăci `IceSlabHazard` din #284); hovercraft = figurant cu suflu pe larg + traversări pe culoar (0.30 hovercraft, 0.50 sania pescarului); tren PE SENS pe viaduct (`TrainHazard.along_road` + AI care se ține de margine); torosuri (`custom_hummock_fracs`, 2 buc.); arcada grotei (granit, placeholder) | #284–#286, #288, #290, #312 |
