...
| **C** | 0.40–0.485 | **Câmpul de plăci crăpate** — un câmp de presiune RIDICAT ~0.4 m peste placa lacului (rampe naturale la intrare/ieșire), spart Voronoi în plăci poligonale de 5–8 m **denivelate** (pantă și cotă aleatoare per placă, trepte de 8–15 cm între vecine — drumul prost al pistei, simțit în suspensie la orice viteză; reglaj din playtest, câmpul coplanar nu se simțea deloc), iar câmpul e tăiat diagonal de **creste de presiune (toroși) la ~20 m** una de alta, înalte 0.58 m cu pante de 17.6%: pe ele gheața se sparge în sloiuri mici (semințe Voronoi dese **doar pe linia vârfului**, ca muchia dintre două plăci să cadă exact pe creastă) și de acolo mașina chiar **zboară** — 0.33 s în aer, 23% din câmp fără roți pe gheață, cu viteza păstrată. Creasta e mai joasă spre un capăt (alternând partea), deci alegi pe unde o treci. De ce creastă și nu placă ridicată: mașina nu e aruncată de pantă, ci de terenul care îi **fuge de sub roți** dincolo de vârf — vechile kickere dădeau 0.16 s de aer (gravitația jocului e 28 m/s², nu 9.8), adică o zgâlțâitură cu fisuri de apă neagră între ele; apa se vede DOAR în fisuri, nu ca ramă (implementat în #314: `IceFieldHazard`, generat din probele traseului; feel-ul în follow-up) | 8 **plăci „vii"** pe culoar, marcate cinstit cu față vizibil mai închisă (gheață subțire, se vede apa prin ea), pânză albă de crăpături și fisuri mai late în jur: se **așază** ~10 cm sub orice mașină cu trosnet la contact, se **înclină** spre colțul încărcat (arc rapid) și **acumulează stricăciune** la fiecare trecere (masă × timp; turbo dublează, nu se vindecă între treceri): a 3-a trecere normală / a 2-a cu turbo / prima a unui mastodont boostat o **rupe** — trosnet mare, țâșnitură, placa se scufundă sub linia apei 2 s și cine e pe ea e repus, apoi revine cu stricăciunea ștearsă. Skill-ul = citești câmpul, alegi linia și ții minte câte treceri are placa în ea | 22 m (semilățime 11), câmpul iese ~5 m lateral de culoar; AI-urile se împrăștie prin `line_offset` |
