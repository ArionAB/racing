...
const RES := {
	...
	"baikal/structures/viaduct_pier": "22_via_pier",
	"baikal/structures/viaduct_arch": "22_via_arch",
	"baikal/structures/viaduct_end": "22_via_end",
...
func _specs() -> Array[Dictionary]:
	return [
		...
		# nu in asset.
		# Din august 2026 fiecare modul e FISIERUL lui (zidaria si patul de cale
		# ferata sunt obiecte separate, ca zidaria sa poata lua clasa
		# `cut_stone`), deci nu mai e nimic de stins: fara `keep`.
		{"poi": "G", "kind": "row", "model": "baikal/structures/viaduct_arch",
			"name": "Arcada", "spans_road": true, "from": 0.716, "to": 0.760, "spacing": 12.0,
			"side": 1.0, "off": -14.0, "scale": 1.0, "face": "along"},
		{"poi": "G", "kind": "row", "model": "baikal/structures/viaduct_pier",
			"name": "Pila", "spans_road": true, "from": 0.716, "to": 0.766, "spacing": 12.0,
			"side": 1.0, "off": -14.0, "scale": 1.0, "face": "along"},
		{"poi": "G", "kind": "one", "model": "baikal/structures/viaduct_end",
		...
		{"poi": "G", "kind": "one", "model": "baikal/structures/railway_tunnel_portal",
			...
			"scale": 1.0, "face": "along",
			"keep": ["Tunnel_Portal", "Tunnel_Bore", "Tunnel_Bore_Ice",
				"Tunnel_Niche"]},
		{"poi": "G", "kind": "one", "model": "baikal/structures/railway_tunnel_portal",
