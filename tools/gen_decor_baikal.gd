...
const RES := {
	...
	"baikal/props/serge_pole": "21_serge",
	...
	"baikal/props/village_props": "31_vprops",
	"baikal/vehicles/uaz_bukhanka": "32_uaz",
	"baikal/vehicles/kamaz_truck": "33_kamaz",
	"baikal/props/ice_kit": "34_ice",
	"baikal/trees/forest_kit": "35_forest",
	"baikal/props/shore_kit": "36_shore",
...
func _specs() -> Array[Dictionary]:
	return [
		...
		{"poi": "A", "kind": "row", "model": "baikal/buildings/log_house_a",
			...
			"yaw_jitter": 7.0,
			"model_cycle": ["baikal/buildings/log_house_a", "baikal/buildings/log_house_c",
		...
		{"poi": "A", "kind": "row", "model": "baikal/buildings/log_house_b",
			...
			"yaw_jitter": 7.0,
			"model_cycle": ["baikal/buildings/log_house_b", "baikal/buildings/log_house_a"]},
		# Gardul continuu intre case — semnatura satului in diorama.
		{"poi": "A", "kind": "row", "model": "baikal/props/village_props",
		...
		{"poi": "A", "kind": "one", "model": "baikal/props/village_props",
			"name": "Sanie", "frac": 0.015, "side": -1.0, "off": 4.2,
			"scale": 1.0, "face": "along", "keep": ["Sled"]},
		{"poi": "A", "kind": "one", "model": "baikal/props/village_props",
		...
		{"poi": "A", "kind": "one", "model": "baikal/props/village_props",
			...
			"scale": 1.0, "face": "random", "keep": ["BarrelsCrates"]},
		...
		{"poi": "B", "kind": "row", "model": "baikal/props/serge_pole",
			"name": "Serge", "from": 0.093, "to": 0.121, "spacing": 3.6,
			"side": 1.0, "off": 3.0, "scale": 1.0, "face": "road",
			"yaw_jitter": 6.0,
			"keep_cycle": [["Serge_A"], ["Serge_B"], ["Serge_C"]]},
		{"poi": "B", "kind": "one", "model": "baikal/props/shore_kit",
			"name": "Scari", "frac": 0.126, "side": -1.0, "off": 9.0,
			"scale": 1.0, "face": "road", "keep": ["ShoreStaircase"]},
		{"poi": "B", "kind": "cluster", "model": "baikal/props/shore_kit",
			"name": "Bolovan", "frac": 0.104, "count": 7, "side": 0.0,
			"spread_along": 26.0, "off": 7.0, "off_jitter": 5.0,
			"scale": 1.0, "scale_jitter": 0.25, "face": "random",
			"sink": 0.2, "keep_cycle": [["BoulderLichen_A"],
				["BoulderLichen_B"], ["BoulderLichen_C"]]},
		...
		{"poi": "B2", "kind": "row", "model": "baikal/props/ice_kit",
		...
		{"poi": "B2", "kind": "row", "model": "baikal/props/ice_kit",
			...
			"side": -1.0, "off": 3.4, "scale": 1.0, "face": "road",
			"on_ice": true, "keep_cycle": [["IceRoadMarker"]]},
		{"poi": "B2", "kind": "one", "model": "baikal/props/ice_kit",
		...
		{"poi": "C", "kind": "one", "model": "baikal/props/ice_kit",
		...
		{"poi": "C", "kind": "one", "model": "baikal/props/ice_kit",
			...
			"scale": 1.0, "face": "road", "on_ice": true,
			"keep": ["IceRoadSign"]},
		{"poi": "C", "kind": "cluster", "model": "baikal/props/ice_kit",
		...
		# ------------------------------------------- D: campul de placi
		{"poi": "D", "kind": "cluster", "model": "baikal/props/ice_kit",
		...
		{"poi": "D", "kind": "cluster", "model": "baikal/props/ice_kit",
			...
			"on_ice": true, "keep_cycle": [["IceBlockStack"]]},
		...
		{"poi": "E", "kind": "one", "model": "baikal/structures/ice_grotto_arch",
			...
			"keep": ["Grotto_Rock", "Grotto_Ice", "Icicle_A", "Icicle_B",
				"Icicle_C", "Icicle_D"]},
		{"poi": "E", "kind": "row", "model": "baikal/props/shore_kit",
			"name": "Faleza", "from": 0.572, "to": 0.606, "spacing": 17.0,
			"side": -1.0, "off": 12.0, "scale": 1.0, "face": "road",
			"yaw_jitter": 10.0, "keep_cycle": [["CliffFaceOlkhon"]]},
		...
		{"poi": "F", "kind": "one", "model": "baikal/props/ice_kit",
		...
		{"poi": "F", "kind": "one", "model": "baikal/props/ice_kit",
			...
			"scale": 1.0, "face": "road", "on_ice": true, "yaw_jitter": 25.0,
			"keep": ["FisherTent_Orange"]},
		{"poi": "F", "kind": "cluster", "model": "baikal/props/ice_kit",
		...
		{"poi": "F", "kind": "cluster", "model": "baikal/props/village_props",
		...
		{"poi": "H", "kind": "row", "model": "baikal/trees/forest_kit",
		...
		{"poi": "H", "kind": "row", "model": "baikal/trees/forest_kit",
			...
			"off_jitter": 4.0, "keep_cycle": [["PineSiberian_A"],
				["PineSiberian_B"]]},
		...
		{"poi": "H", "kind": "row", "model": "baikal/trees/forest_kit",
			...
			"off_jitter": 3.0, "keep_cycle": [["BirchWinter_A"],
				["BirchWinter_B"]]},
		{"poi": "H", "kind": "row", "model": "baikal/props/shore_kit",
		...
		{"poi": "H", "kind": "row", "model": "baikal/props/shore_kit",
			...
			"off_jitter": 1.5, "sink": 0.1, "keep_cycle": [["GrassTuftDry"],
				["ShrubSnow"]]},
		{"poi": "H", "kind": "one", "model": "baikal/props/shore_kit",
		...
		{"poi": "H", "kind": "cluster", "model": "baikal/props/shore_kit",
			...
			"keep_cycle": [["BoulderLichen_C"], ["BoulderLichen_B"]]},
		...
		{"poi": "I", "kind": "row", "model": "baikal/props/village_props",
