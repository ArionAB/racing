...
const RES := {
	"rocks/shaman_rock": "20_shaman",
	"props/serge_pole": "21_serge",
	"structures/railway_viaduct": "22_viaduct",
	"structures/railway_tunnel_portal": "23_tunnel",
	"structures/ice_grotto_arch": "24_grotto",
	"buildings/khuzhir_church": "25_church",
	"vehicles/hovercraft_khivus": "26_khivus",
	...
	"props/ice_kit": "34_ice",
	"trees/forest_kit": "35_forest",
	"props/shore_kit": "36_shore",
	"props/husky_dog": "37_husky",
	"props/nerpa_seal": "38_nerpa",
}
...
func _specs() -> Array[Dictionary]:
	return [
		...
		{"poi": "A", "kind": "one", "model": "structures/start_gate_logs",
		...
		{"poi": "B", "kind": "one", "model": "rocks/shaman_rock",
		...
		{"poi": "C", "kind": "one", "model": "props/ice_kit",
		...
		# nu in asset.
		{"poi": "G", "kind": "row", "model": "structures/railway_viaduct",
		...
		{"poi": "G", "kind": "one", "model": "structures/railway_viaduct",
		...
		{"poi": "G", "kind": "one", "model": "structures/railway_viaduct",
			...
			"scale": 1.0, "face": "along", "keep": ["Viaduct_End"]},
		{"poi": "G", "kind": "one", "model": "structures/railway_tunnel_portal",
		...
		{"poi": "H", "kind": "row", "model": "props/shore_kit",
			...
			"off_jitter": 1.5, "sink": 0.1, "keep_cycle": [["GrassTuftDry"],
				["ShrubSnow"]]},
		{"poi": "H", "kind": "one", "model": "props/shore_kit",
		...
		{"poi": "H", "kind": "row", "model": "structures/power_pylon_soviet",
			"name": "Stalp", "from": 0.872, "to": 0.928, "spacing": 26.0,
			"side": -1.0, "off": 34.0, "scale": 1.0, "face": "along"},
		{"poi": "H", "kind": "cluster", "model": "props/shore_kit",
